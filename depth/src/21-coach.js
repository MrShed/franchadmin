...
var UICoach = (function () {
  ...
  var SCRIPTS = {
    tutorial: [
      ...
      { el: function () { return vis('.sb-btns .next') || vis('.sb-strip'); }, go: 'receiver', title: 'The first broadcast', text: 'The case file gives the controller’s schedule. Wait for it — the dial will be set close to its frequency.', wait: 'waited' },
      { el: function () { return vis('#rx-fine') ; }, title: 'Centre it', text: 'Turn FINE — or drag the green trace on the display — until it sits on the red hairline. The whistle drops away when you are dead on. Voice needs the lever on AM.', wait: 'copyready', place: 'top' },
