...
(function () {
  ...
  // ------------------------------------------------------------- helpers
  // pattern: '#' digit, '9' non-zero digit, '@' letter, anything else literal
  function pat(p, R) {
    var s = '';
    for (var i = 0; i < p.length; i++) {
      var c = p.charAt(i);
      if (c === '#') s += R.digits(1);
      else if (c === '9') s += String(R.int(1, 9));
  ...
  var NAT = {
    ...
    CH: { adj: 'Swiss', country: 'Switzerland', pass: '9#######', bloc: 'W',
  ...
  var CITIES = {
    VIE: { name: 'Vienna', cc: 'AT', phone: '+43 1 ### ## ##', plate: 'W ##.###', post: 'Wien', addr: '{s} {n}/{f}, {z} Wien',
      ...
      venues: [{ n: 'Staatsoper', k: 'opera', a: 'Opernring 2' }, { n: 'Hofburg Congress Centre', k: 'hall', a: 'Heldenplatz' }, { n: 'Federal Chancellery', k: 'ministry', a: 'Ballhausplatz 2' }, { n: 'Palais Auersperg', k: 'ballroom', a: 'Auerspergstraße 1' }, { n: 'Messe Wien, Rotunde halls', k: 'fair', a: 'Messeplatz 1' }, { n: 'Institute for Radium Research', k: 'institute', a: 'Boltzmanngasse 3' }, { n: 'University of Vienna, main building', k: 'university', a: 'Dr.-Karl-Lueger-Ring 1' }],
    ...
    WBE: { name: 'West Berlin', cc: 'WB', phone: '+49 30 ### ## ##', plate: 'B-@@ ###', addr: '{s} {n}, {z} Berlin {d}',
      ...
      venues: [{ n: 'ICC Berlin', k: 'hall', a: 'Messedamm 19' }, { n: 'Deutsche Oper Berlin', k: 'opera', a: 'Bismarckstraße 35' }, { n: 'Schöneberg Town Hall', k: 'ministry', a: 'John-F.-Kennedy-Platz' }, { n: 'Messe am Funkturm', k: 'fair', a: 'Messedamm 22' }, { n: 'Technical University, Physics Institute', k: 'institute', a: 'Hardenbergstraße 36' }, { n: 'Hotel Palais am Zoo, Great Hall', k: 'ballroom', a: 'Budapester Straße 40' }],
    ...
    BUD: { name: 'Budapest', cc: 'HU', phone: '+36 1 ### ####', plate: '@@@-###', addr: '{s} {n}. {f}, {z} Budapest', zip: ['1051', '1061', '1072', '1085', '1092', '1113', '1136'],
      ...
      venues: [{ n: 'Hungarian State Opera', k: 'opera', a: 'Andrássy út 22' }, { n: 'Parliament (Országház)', k: 'ministry', a: 'Kossuth Lajos tér 1' }, { n: 'Budapest Convention Centre', k: 'hall', a: 'Jagelló út 1' }, { n: 'Hungexpo fairground', k: 'fair', a: 'Albertirsai út 10' }, { n: 'Central Research Institute for Physics (KFKI)', k: 'institute', a: 'Konkoly-Thege út 29' }, { n: 'Hotel Duna-Palota, ballroom', k: 'ballroom', a: 'Apáczai Csere János u. 4' }],
    ...
    ZRH: { name: 'Zurich', cc: 'CH', phone: '+41 1 ### ## ##', plate: 'ZH ### ###', addr: '{s} {n}, {z} Zürich', zip: ['8001', '8003', '8004', '8005', '8006', '8008', '8032'],
      ...
      venues: [{ n: 'Zurich Opera House', k: 'opera', a: 'Falkenstrasse 1' }, { n: 'Kongresshaus Zürich', k: 'hall', a: 'Claridenstrasse 5' }, { n: 'ETH, Institute for Applied Physics', k: 'institute', a: 'Hönggerberg' }, { n: 'Grand Hotel Limmat, Salle Belvoir', k: 'ballroom', a: 'Limmatquai 24' }, { n: 'Swiss National Museum', k: 'museum', a: 'Museumstrasse 2' }, { n: 'Züspa exhibition halls', k: 'fair', a: 'Wallisellenstrasse 49' }],
    ...
    GVA: { name: 'Geneva', cc: 'CH', phone: '+41 22 ## ## ##', plate: 'GE ### ###', addr: '{s} {n}, {z} Genève', zip: ['1201', '1202', '1203', '1204', '1205', '1207'],
      ...
      venues: [{ n: 'Palais des Nations', k: 'hall', a: 'avenue de la Paix 14' }, { n: 'Grand Théâtre de Genève', k: 'opera', a: 'place de Neuve 5' }, { n: 'Permanent Mission of the FRG', k: 'embassy', a: 'rue de Moillebeau 28' }, { n: 'CERN, Meyrin site', k: 'institute', a: 'route de Meyrin' }, { n: 'Palexpo', k: 'fair', a: 'route François-Peyrot 30' }, { n: 'Hôtel Léman-Palace, Salon des Glaces', k: 'ballroom', a: 'quai du Mont-Blanc 11' }],
    ...
    ROM: { name: 'Rome', cc: 'IT', phone: '+39 6 ### ####', plate: 'ROMA 9@####', addr: '{s} {n}, int. {f}, {z} Roma', zip: ['00184', '00185', '00186', '00153', '00161', '00176', '00198'],
      ...
      venues: [{ n: 'Teatro dell\'Opera', k: 'opera', a: 'Piazza Beniamino Gigli 7' }, { n: 'Palazzo della Farnesina', k: 'ministry', a: 'Piazzale della Farnesina 1' }, { n: 'Palazzo dei Congressi, EUR', k: 'hall', a: 'Piazza J. F. Kennedy 1' }, { n: 'Fiera di Roma', k: 'fair', a: 'Via Cristoforo Colombo 285' }, { n: 'La Sapienza, Physics Institute', k: 'university', a: 'Piazzale Aldo Moro 5' }, { n: 'Embassy of Austria', k: 'embassy', a: 'Via Pergolesi 3' }],
    ...
    PAR: { name: 'Paris', cc: 'FR', phone: '+33 1 4# ## ## ##', plate: '#### @@ 75', addr: '{n}, {s}, {z} Paris', zip: ['75004', '75010', '75011', '75012', '75014', '75018', '75020'],
      ...
      venues: [{ n: 'Opéra Garnier', k: 'opera', a: 'place de l\'Opéra' }, { n: 'Quai d\'Orsay (Foreign Ministry)', k: 'ministry', a: '37 quai d\'Orsay' }, { n: 'Palais des Congrès', k: 'hall', a: 'Porte Maillot' }, { n: 'Parc des Expositions', k: 'fair', a: 'Porte de Versailles' }, { n: 'Collège de France', k: 'university', a: '11 place Marcelin-Berthelot' }, { n: 'Hôtel Wagram-Étoile, salons', k: 'ballroom', a: '20 avenue de Wagram' }, { n: 'Embassy of the FRG', k: 'embassy', a: '13-15 avenue Franklin-D.-Roosevelt' }],
    ...
    MRS: { name: 'Marseille', cc: 'FR', phone: '+33 91 ## ## ##', plate: '#### @@ 13', addr: '{n}, {s}, {z} Marseille', zip: ['13001', '13002', '13005', '13006', '13007', '13003'],
      ...
      venues: [{ n: 'Opéra de Marseille', k: 'opera', a: '2 rue Molière' }, { n: 'Préfecture des Bouches-du-Rhône', k: 'ministry', a: 'place Félix-Baret' }, { n: 'Palais du Pharo', k: 'hall', a: '58 boulevard Charles-Livon' }, { n: 'Parc Chanot', k: 'fair', a: 'rond-point du Prado' }, { n: 'Musée Cantini', k: 'museum', a: '19 rue Grignan' }, { n: 'Grand Hôtel Canebière, salons', k: 'ballroom', a: '26 la Canebière' }],
    ...
    IST: { name: 'Istanbul', cc: 'TR', phone: '+90 1 ### ## ##', plate: '34 @@ ###', addr: '{s} No:{n} D:{f}, {z} İstanbul', zip: ['Beyoğlu', 'Şişli', 'Fatih', 'Beşiktaş', 'Kadıköy', 'Eminönü'],
      ...
      venues: [{ n: 'Atatürk Cultural Centre', k: 'opera', a: 'Taksim Meydanı' }, { n: 'Dolmabahçe Palace, reception halls', k: 'ministry', a: 'Dolmabahçe Caddesi' }, { n: 'Consulate-General of the FRG', k: 'embassy', a: 'İnönü Caddesi 16' }, { n: 'Tüyap fair halls', k: 'fair', a: 'Tepebaşı' }, { n: 'Istanbul Technical University', k: 'university', a: 'Maçka' }, { n: 'Grand Hotel Bosphorus, ballroom', k: 'ballroom', a: 'Meclis-i Mebusan Caddesi 14' }],
  ...
  // ---------------------------------------------------------- targets
  var TRAITS = [
    { cat: 'music', code: 'the Musician', t: ['a keen amateur organist who plays most Sundays at his parish church', 'plays the viola in a string quartet of retired diplomats', 'has not missed a Bayreuth season since 1962', 'sang bass in the university choir and, colleagues say, still does in the car'] },
    { cat: 'sea', code: 'the Sailor', t: ['an accomplished yachtsman who crossed the Bay of Biscay single-handed', 'keeps a small ketch on Lake Constance', 'served in the navy and still refers to the ministry canteen as the galley'] },
