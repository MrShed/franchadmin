...
var UIDebrief = {
  show: function () {
    ...
    var html = '<div class="db oc-' + UIesc(oc.kind || 'resigned') + '"><div class="db-glow"></div><canvas class="db-bg" id="db-bg"></canvas><div class="db-in">' +
